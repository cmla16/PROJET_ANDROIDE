...
def mono1_somme_des_rangs(path1, path2, path3, path4, path5, coverage):
    ...
    model.setObjective(sum(rang[e, u] * x[e, u] for e, u in rang), GRB.MINIMIZE)
    ...
    if model.status == GRB.OPTIMAL:
        attributions("mono1_somme_des_rangs", x, y, parcours, ue_obligatoires, ue_preferences, groupes_td)

    return model.ObjVal

if __name__ == "__main__":
    mono1_somme_des_rangs(
