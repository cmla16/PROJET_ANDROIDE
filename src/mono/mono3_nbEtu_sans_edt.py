...
def mono3_nbEtu_sans_edt(path1, path2, path3, path4, path5, multi_general=False,capacity=False,delta=0,comp_td={}):
    ...
    # Modèle
    # Minimiser le nombre d'étudiant sans emploi du temps valide 
    ...
    for e in parcours:
        # Contrainte: chaque étudiant doit obtenir assez d'ECTS pour avoir un contrat
